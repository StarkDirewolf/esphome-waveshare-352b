...
WaveshareEPaper3P52InBWR = waveshare_epaper_ns.class_(
    "WaveshareEPaper3P52InBWR", WaveshareEPaperBWR
)
...
MODELS = {
    ...
    "3.52in-bwr": ("b", WaveshareEPaper3P52InBWR),
...
RESET_PIN_REQUIRED_MODELS = ("2.13inv2", "2.13in-ttgo-b74", "3.52in-bwr")
